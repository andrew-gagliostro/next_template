...
export default function FollowCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setFollowing_id(initialValues.following_id);
    setFollowed_id(initialValues.followed_id);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Follow(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "FollowCreateForm")}
      {...rest}
    >
      <TextField
        label="Following id"
